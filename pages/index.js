  ...
  <Layout header="hero" id="/">
    ...
    <section className="lead">
      <div className="contain">
        ...
        <p className="alert">Alistair has started a new position at <a href="https://www.thecoveyagency.com/">The Covey Agency</a> as a Full Stack Developer and hence we are taking on less projects that previously. If you are looking for a static site, a fairly small project, or a Front-End Web App, then feel free to still get in touch. <a href="https://www.thecoveyagency.com/">The Covey Agency</a> is a creative and digital agency in Portobello, Edinburgh offering services including graphic design, branding, traditional marketing and advertising, website design, development and hosting, digital marketing and SEO and more.<br />If you are looking for any of these services, get in touch with with Alistair (through Accudio) or with <a href="https://www.thecoveyagency.com/">The Covey Agency</a> directly and we can see what we can do for you.
        </p>
